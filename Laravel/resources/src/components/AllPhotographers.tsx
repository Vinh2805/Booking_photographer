...
const allPhotographers: Photographer[] = [
  {
    ...
    responseTime: "< 1 giờ",
    description:
      "Chuyên chụp ảnh cưới và gia đình với phong cách tự nhiên và lãng mạn",
  ...
  },
  {
    ...
    responseTime: "< 2 giờ",
    description:
      "Chuyên gia chụp ảnh chân dung và thời trang với góc nhìn nghệ thuật",
  ...
  },
  {
    ...
    description:
      "Chuyên gia chụp ảnh sự kiện và doanh nghiệp với kinh nghiệm 8+ năm",
  ...
  },
  {
    ...
    responseTime: "< 1 giờ",
    description:
      "Chuyên chụp ảnh gia đình và trẻ em với không gian studio hiện đại",
  ...
  },
  {
    ...
    avatar:
      "https://images.unsplash.com/photo-1619380061814-58f03707f082?w=100&h=100&fit=crop&crop=face",
    coverImage:
...
export function AllPhotographers({
  onBack,
  onBookPhotographer,
}: AllPhotographersProps) {
  ...
  const getSpecialtyCount = (specialty: string) => {
    ...
    return allPhotographers.filter((p) => p.specialties.includes(specialty))
      .length;
  };
          ...
          <div className="flex items-center gap-1">
            <div
              className={`w-2 h-2 rounded-full ${
                photographer.isOnline ? "bg-green-500" : "bg-gray-400"
              }`}
            />
            ...
            <div className="flex items-center gap-4 text-black dark:text-slate-200">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Khám phá và tìm kiếm nhiếp ảnh gia phù hợp
                </p>
              </div>
            </div>
            <ThemeToggle />
            ...
            <div className="flex items-center gap-4 flex-wrap">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button
                    variant="outline"
                    className="h-10 border-primary/20 hover:bg-primary/5 hover:border-primary/40"
                  >
                ...
                <DropdownMenuContent
                  className="w-80 p-4 bg-card border-primary/20 shadow-xl"
                  align="start"
                >
                          ...
                          <Button
                            ...
                            onClick={() =>
                              setSelectedSpecialty(
                                specialty === "Tất cả" ? null : specialty
                              )
                            }
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 gap-2">
                        ...
                        >
                          ...
                          <span className="ml-auto bg-primary/10 text-primary px-1.5 py-0.5 rounded text-xs">
                            {
                              allPhotographers.filter((p) => p.isVerified)
                                .length
                            }
                          </span>
                        </Button>
