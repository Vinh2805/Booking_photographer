...
const mockPhotographers: Photographer[] = [
  ...
  },
  {
    ...
    responseTime: "< 3 giờ",
    description:
      "Chuyên chụp ảnh chân dung và thời trang với góc nhìn nghệ thuật",
  },
];

export function PhotographerDiscovery({
  onBack,
  onBookPhotographer,
}: PhotographerDiscoveryProps) {
  ...
  const getSpecialtyCount = (specialty: string) => {
    ...
    return mockPhotographers.filter((p) => p.specialties.includes(specialty))
      .length;
  };
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Tìm kiếm nhiếp ảnh gia phù hợp với nhu cầu của bạn
                </p>
              </div>
            </div>
            <ThemeToggle />
