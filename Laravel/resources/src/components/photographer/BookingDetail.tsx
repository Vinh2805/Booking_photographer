                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="space-y-3 mt-2">
                                        {/* Genre */}
                                        {booking.services?.genre && booking.services.genre.length > 0 && (
                                            <div>
                                                <span className="text-xs text-muted-foreground block mb-1">Gói chụp:</span>
                                                <div className="flex flex-wrap gap-2">
                                                    {booking.services.genre.map((s: any) => (
                                                        <Badge key={s.Ma_DV} variant="secondary" className="bg-blue-50 text-blue-700 hover:bg-blue-100">
                                                            {s.Ten_DV}
                                                        </Badge>
                                                    ))}
                                                </div>
                                        ...
                                        {/* Context */}
                                        {booking.services?.context && booking.services.context.length > 0 && (
                                            <div>
                                                <span className="text-xs text-muted-foreground block mb-1">Bối cảnh:</span>
                                                <div className="flex flex-wrap gap-2">
                                                    {booking.services.context.map((s: any) => (
                                                        <Badge key={s.Ma_DV} variant="outline" className="border-purple-200 text-purple-700">
                                                            {s.Ten_DV}
                                                        </Badge>
                                                    ))}
                                                </div>
                                        ...
                                        {/* Extras */}
                                        {booking.services?.extras && booking.services.extras.length > 0 && (
                                            <div>
                                                <span className="text-xs text-muted-foreground block mb-1">Dịch vụ thêm:</span>
                                                <div className="flex flex-wrap gap-2">
                                                    {booking.services.extras.map((s: any) => (
                                                        <Badge key={s.Ma_DV} variant="outline" className="border-orange-200 text-orange-700">
                                                            + {s.Ten_DV}
                                                        </Badge>
                                                    ))}
                                                </div>
                                        ...
                                        {(!booking.services || (booking.services.genre.length === 0 && booking.services.context.length === 0 && booking.services.extras.length === 0)) && (
