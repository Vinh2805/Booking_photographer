...
<head>
    ...
    <title>VNPAY - Thanh toán thất bại</title>
    <style>
        * {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <h3>VNPAY - Thanh toán thất bại</h3>
        </div>
        ...
        <div class="table-responsive">
            ...
            <div class="message-box">
                <strong>Thông báo:</strong> {{ $message ?? 'Thanh toán thất bại hoặc bị hủy' }}
            </div>
            
            <div class="form-group">
                <label>Kết quả:</label>
                <label>
                    <span class="result-badge result-failed">Giao dịch không thành công</span>
                </label>
            </div>
        </div>
